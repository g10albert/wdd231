const courseList = document.querySelector("#courses-info");

const allCoursesBtn = document.querySelector("#all");
...
function displayCourses(course) {
  html = `
    <div class="course ${course.completed === true ? "completed" : ""}">
  ...
  totalCreditsContainer.innerHTML = `The total credits for courses listed above is: ${totalCredits}`;
}
